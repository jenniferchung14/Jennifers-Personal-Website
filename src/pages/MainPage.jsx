    ...
    <div className="main-page">
      <div class="container">
        <div class="text-area">
            ...
            <p>I'm Jennifer and I am in my fifth and final year of Computer Science at <b><a href="https://www.torontomu.ca/" class="a-links" target="_blank">Toronto Metropolitan University</a></b> <i>{"(formerly Ryerson)"}</i>, where I am also minoring in Psychology. I'm an aspiring Software Engineer who currently has a keen interest in web and front-end development.</p>
